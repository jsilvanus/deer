...
![seedeer Logo: a deer with vector numbers between antlers. Logo generated by ChatGPT. Public Domain.](assets/seedeer.png)

A Node.js vision-model toolkit — the vision counterpart to
[`@jsilvanus/embedeer`](https://github.com/jsilvanus/deer/tree/main/packages/embedeer) (text
embeddings) and [`@jsilvanus/chattydeer`](https://github.com/jsilvanus/deer/tree/main/packages/chattydeer)
